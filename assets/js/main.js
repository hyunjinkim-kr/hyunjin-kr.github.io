...
function blog_posts() {
    ...
    let posts = [
        {
            url: 'https://portfolio-five-khaki-81.vercel.app/projects',
    ...
    // for the more posts link : https://www.nagekar.com -> https://portfolio-five-khaki-81.vercel.app/
    let post_template = `
    <div class="blog-post more-blogs" onclick="blog_link_click('https://portfolio-five-khaki-81.vercel.app/');">

        <div class="blog-link">

            <h3><a href="https://portfolio-five-khaki-81.vercel.app/">Visit the blog for more posts</a></h3>            
